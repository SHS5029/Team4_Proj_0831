...
- [마스터플랜의 WU-M10 범위](개발상세플랜/AI_MAFIA_MASTER_PLAN.md)
- [API 계약](개발상세플랜/AI_MAFIA_API_SPEC.md)
- [MCP 서버 설계](개발상세플랜/AI_MAFIA_MCP_SERVER_DESIGN.md)
- [DB 저장 계약](개발상세플랜/AI_MAFIA_DB_DESIGN.md)
- [화면 연결 계획](개발상세플랜/AI_MAFIA_SCREEN_FLOW.md)
- [실행·검증 안내](../README.md)
