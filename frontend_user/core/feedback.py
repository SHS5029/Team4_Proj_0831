...
def build_feedback(*, feedback_type: str, rating: int, comment: str, tags: list[str], game_id: str | None = None) -> dict[str, Any]:
    ...
    if normalized and (len(normalized) > 1000 or any(unicodedata.category(char).startswith("C") for char in normalized)):
    ...
    body: dict[str, Any] = {"feedback_type": feedback_type, "rating": rating, "comment": normalized or None, "tags": tags}
