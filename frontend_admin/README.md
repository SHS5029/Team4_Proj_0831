...
7.4~7.10과 연결됩니다. metrics의 users_total·daily_games, persona-win-rates,
feedback, audit-logs, speech-analytics 응답을 사용합니다.
...
관리자 로그의 조회 유형은 현재 화면에서 실제로 연동하는 운영 지표·페르소나 승률·AI 발언 분석·피드백 목록·감사 로그만 제공합니다.
